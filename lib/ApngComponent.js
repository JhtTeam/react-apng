...
var ApngComponent = function (_React$Component) {
    ...
    _createClass(ApngComponent, [{
        ...
        value: function render() {
            ...
            return staticImg ? _react2.default.createElement('img', _extends({ src: staticImg }, this.props, { alt: '\u9759\u6001\u56FE\u7247' })) : _react2.default.createElement('canvas', _extends({ ref: function ref(canvasBox) {
                    return _this2.canvasBox = canvasBox;
                } }, this.props));
        }
    }]);
                ...
                switch (_context.prev = _context.next) {
                    ...
                    case 17:
                        ...
                        if (autoPlay) {
                            _this3.player.play();
                            _this3.isPlay = true;
                            if (_this3.props.onPlay) {
                                _this3.props.onPlay(true);
                            }
                        }
                        _this3.player.on('end', function () {
                            _this3.isPlay = false;
                            if (_this3.props.onPlay) {
                                _this3.props.onPlay(false);
                            }
                        });
                        _context.next = 25;
                        break;

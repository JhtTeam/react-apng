    ...
    _createClass(Frame, [{
        ...
        value: function createImage() {
            ...
            return new Promise(function (resolve, reject) {
                var hasSupportURL = false; //(typeof (URL) !== 'undefined');
                var url = hasSupportURL ? URL.createObjectURL(_this2.imageData) : null;
                ...
                if (url) {
                    ...
                    var imageElement = _this2.imageElement;
                    var reader = new FileReader();
                    reader.onload = function (evt) {
                        imageElement.src = reader.result;
                    };
                    reader.readAsDataURL(_this2.imageData);
                }
            });
        }
    }]);
